    ...
    Particle.prototype.second_process = function () {
            ...
            for (let a = 0; a < cell.length; a++) {
              ...
              if (particle !== this) {
                ...
                if (distance < spacing) {
                  ...
                  inputVal.value = particle.input
                  outputVal.value = particle.output
      ...
      for (let i = 0; i < close.length; i++) {
        ...
        if (this.type !== neighbor.type) {
          press *= (pressureViscosity / pressureSpeed) * 0.27
        }
    ...
    return {
      init: function () {
        ...
        for (let i = 0; i < GROUPS.length; i++) {
          ...
          if (inputVal.value < 0.2) {
            color = 'hsla(10, 10%, 110%';
          } else if (inputVal.value >= 0.3 && inputVal.value < 0.6) {
            color = 'hsla(10, 90%, 10%';
          } else {
